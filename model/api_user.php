...
class UserModel
{
    //TODO: 我们没有使用transaction，作为TeamLeader, yangsong01愿意为此事付全部责任
    //      yangsong01陈述如下：
    //          我清楚的知道我们在做什么，也知道这个操作可能会带来脏数据，但是作为一个展示
    //          类型app中的cms，我觉得这个事情是可以容忍的。如果后来的team leader觉得不合适
    //          可以自行研究加入你的transaction，我这个mailstone和任期内不会修正这个bug.
    //
    //                                      yangsong01 于 
    //                                      Tue Dec 11 16:17:08 CST 2012
    //
    private $_db;
