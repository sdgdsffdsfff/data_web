                            ...
                            <div class="tab-content">
                                <div class="tab-pane <?=(isset($_POST['search_type'])&&$_POST['search_type']==1)||!isset($_POST['search_type'])?'active':''?>" id="tab_1">
                                    <div class="box box-primary">
                                        ...
                                        <form id="faseQueryForm_1" action="/web/chaxun/refer" method="post">
                                ...
                                <div class="tab-pane <?=(isset($_POST['search_type'])&&$_POST['search_type']==2)?'active':''?>" id="tab_2">
                                    <div class="box box-primary">
                                        ...
                                        <form id="faseQueryForm_2" action="/web/chaxun/refer" method="post">
                                            <div class="box-body form-horizontal">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label text-right">refer：</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" value="<?=(isset($_POST['refer'])&&$_POST['refer']&&$_POST['search_type']==2)?$_POST['refer']:''?>" name="refer" placeholder="请输入一个模糊refer" >
